        ...
        <View>
            {msg.mediaUrl && (
                <View style={styles.mediaWrapper}>
                    ...
                    <TouchableOpacity onPress={()=> Linking.openURL
                        ...
                        <Image source={{uri: msg.mediaUrl}} style={
                            styles.mediaImage
                        }
                        resizeMode='cover'
                        />
            ...
            {msg.text && <Text style={[styles.msgText, isMine ?
             ...
             <View style={[styles.footer, isMine ? styles.footerRight :
                ...
                <Text style={[styles.timeText, isMine ? styles.timeMe:
                     styles.timeThem
                ]}>{formatTime(msg.createdAt)}</Text>

                {isMine && (
                    <Ionicons name={msg.read ? "checkmark-done": 
                        "checkmark"} size={12} 
                        color={msg.read ? Colors.onPrimary : `${Colors.onPrimary}`}/>
                )}
